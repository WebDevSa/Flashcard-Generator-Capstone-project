/*In this file we are creating the createflashcard page which will take the values from the user on sumbiting the form
and that values are used to create the flashcard which will show up on the myflashcard page.
...
and this has been done with the help of formik library */
...
/*we re creating a function which will take values and actions as parameter and will dispatch the action to create 
  ...
  return (
    ...
    >
      {({ values, isSubmitting, setFieldValue }) => (
        <Form className="w-full space-y-5 text-black-500 text-bold font-medium">
          <div className="md:flex flex-col px-10 py-4 bg-white drop-shadow-lg space-y-4 rounded-lg">
            <div className="flex flex-col sm:flex-row items-center space-x-10 pt-3">
              ...
              else it will show the button to add group image from user's device and then display it.*/}
              {groupImg ? (
                <img
                  src={groupImg}
                  alt="groupImg"
                  ...
                  <div className="">
                          ...
                          >
                            ...
                            <div className="flex flex-col space-y-3 md:space-x-10 md:flex-row">
                              ...
                              <div className="flex items-center space-x-2">
                                <button
                                  className={`hidden lg:flex lg:items-center lg:w-[19rem] px-2 py-2 bg-white border-2 border-blue-700 active:border-slate-300 text-blue-700 font-semibold rounded-md space-x-2 `}
                                  disabled={true}
                                >
                    ...
                    <div className="flex justify-center w-full">
                      <button
                        ...
                        type="submit"
                        className="py-4 px-8  bg-red-800 text-white rounded-md"
                      >
                        Create
