/* in this file we are creating a flash card details which is shown when the user clicks on view card which is available on myflashcard page
in starting of this page we will show group name and group description before group name we are having back arrow button onclicking 
on that we will go one step back using useNavigate.
 then we are showing cards name and description of card with card image
...
import TabHands from "../images/tab-hold-e.png";
import Facebook from "../images/facebook.jpg.png";
import Linkedin from "../images/LinkedIn-Icon-.svg";
import Whatsapp from "../images/whatsapp-logo-.png";
import Twitter from "../images/Twitter-logo.svg.webp";
import Mail from "../images/mail images.png";
import {
  FacebookShareButton,
  LinkedinShareButton,
  WhatsappShareButton,
      ...
      <main className="mt-6 grid grid-rows-1 md:grid-cols-4">
        ...
        <section className="col-span-3 md:col-span-2 flex flex-col xl:flex-row items-center w-full bg-white shadow-lg rounded-lg">
          <img
            src={TabHands}
            alt="cardimage"
            className="object-contain w-[32rem] xl:w-[20vw] h-full p-8"
          />
